...
Contains company identifiers and sector classifications:
...
Contains processed analysis outputs:
...
**Format 2: Standard CSV with comma separator (PD/company/analysis data)**
```
